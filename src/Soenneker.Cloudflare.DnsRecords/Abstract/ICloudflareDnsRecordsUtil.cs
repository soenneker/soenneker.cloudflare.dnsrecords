...
public interface ICloudflareDnsRecordsUtil
{
    ...
    ValueTask<DnsRecordsDnsResponseSingle> AddARecord(string zoneId, string name, string content, int ttl = 1, bool proxied = true, CancellationToken cancellationToken = default);
    ...
    /// <param name="proxied">Whether the record should be proxied through Cloudflare.</param>
    /// <param name="cancellationToken">A cancellation token.</param>
    ValueTask<DnsRecordsDnsResponseSingle> AddCnameRecord(string zoneId, string name, string content, int ttl = 1, bool proxied = true, CancellationToken cancellationToken = default);
    ...
    /// <param name="ttl">Time to live in seconds (1 = auto).</param>
    /// <param name="cancellationToken">A cancellation token.</param>
    ValueTask<DnsRecordsDnsResponseSingle> AddTxtRecord(string zoneId, string name, string content, int ttl = 1, CancellationToken cancellationToken = default);
    ...
    /// <param name="ttl">Time to live in seconds (1 = auto).</param>
    /// <param name="cancellationToken">A cancellation token.</param>
    ValueTask<DnsRecordsDnsResponseSingle> AddMxRecord(string zoneId, string name, string content, int priority, int ttl = 1, CancellationToken cancellationToken = default);
